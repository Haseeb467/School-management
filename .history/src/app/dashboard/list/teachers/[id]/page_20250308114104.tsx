                ...
                <div className="flex flex-col lg:flex-row gap-4 p-2  shadow-md">
                    ...
                    <div className="bg-blue-100 w-1/2 py-6 px-4 flex gap-3">
                        ...
                        <div className="w-2/3 flex flex-col justify-between gap=-4">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis exercitationem consequatur maxime recusandae, quia sint tempore incidunt illum debitis laborum.</p>
                        </div>
                    </div>
                    {/* Small card */}
